<x-app-layout><!-- Hamburger Sidebar with Tabbed Content (Tailwind + Alpine.js) -->
<div x-data="{ sidebarOpen: false, activeTab: 'dashboard' }" class="flex h-screen bg-gray-100 dark:bg-gray-900">
    <!-- Sidebar -->
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-gray-800 shadow-lg md:relative md:translate-x-0 transition-transform duration-200 ease-in-out flex flex-col">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-bold text-gray-900 dark:text-white" id="assigned_assets">{{ \App\Models\Assignments::whereNotNull('user_id')->count() }}</div>
                        </div>
                    </div>
